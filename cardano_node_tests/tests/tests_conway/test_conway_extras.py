...
def registered_pool_user(
    ...
    """Create a pool user with registered stake address."""
    key = helpers.get_current_line_str()
    name_template = common.get_test_id(cluster)
    return conway_common.get_registered_pool_user(
        cluster_manager=cluster_manager,
...
class TestConwayExtras:
    ...
    @pytest.mark.testnets
    @pytest.mark.smoke
    def test_info_return_after_expiry(
        self,
        cluster: clusterlib.ClusterLib,
    ...
    @pytest.mark.testnets
    @pytest.mark.smoke
    def test_update_pparams_return_after_expiry(
        self,
        cluster: clusterlib.ClusterLib,
        registered_pool_user: clusterlib.PoolUser,
    ):
        """Test deposit return on update pparams action.
